...
class ProcessHost extends _events.EventEmitter {
  constructor(runnerScript, processName) {
    super();
    this.process = void 0;
  ...
  async startRunner(runnerParams, inheritStdio, env) {
    var _process$stdout$getCo, _process$stdout, _process$stderr$getCo, _process$stderr;
    ...
    const processParams = {
      stdoutParams: {
        ...
        colorDepth: ((_process$stdout$getCo = (_process$stdout = process.stdout).getColorDepth) === null || _process$stdout$getCo === void 0 ? void 0 : _process$stdout$getCo.call(_process$stdout)) || 8
      },
      stderrParams: {
        rows: process.stderr.rows,
        columns: process.stderr.columns,
        colorDepth: ((_process$stderr$getCo = (_process$stderr = process.stderr).getColorDepth) === null || _process$stderr$getCo === void 0 ? void 0 : _process$stderr$getCo.call(_process$stderr)) || 8
      },
