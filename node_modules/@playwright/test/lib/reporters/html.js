...
`);
  ...
  _resolveOptions() {
    ...
    if (outputFolder) outputFolder = _path.default.resolve(this.config._internal.configDir, outputFolder);
    return {
      outputFolder: (_ref = (_reportFolderFromEnv = reportFolderFromEnv()) !== null && _reportFolderFromEnv !== void 0 ? _reportFolderFromEnv : outputFolder) !== null && _ref !== void 0 ? _ref : defaultReportFolder(this.config._internal.configDir),
